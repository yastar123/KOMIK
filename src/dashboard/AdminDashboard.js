      ...
      try {
        ...
        const comicsWithDetails = await Promise.all(
          querySnapshot.docs.map(async (doc) => {
            ...
            const detailSnapshot = await getDocs(
              collection(db, "comics", doc.id, "detailKomik")
            );
        ...
        <div className="container mx-auto px-4 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <button className="bg-white text-purple-600 px-4 py-2 rounded-lg font-medium shadow-md hover:bg-gray-100 transition duration-200">
                Logout
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-black">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {genres.map((genre) => (
                      <label
                        key={genre}
                        className="flex items-center space-x-2 text-sm cursor-pointer hover:bg-gray-50 p-1.5 rounded-md transition"
                      >
                        <input
                          type="checkbox"
                          value={genre}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {statuses.map((status) => (
                      <label
                        key={status}
                        className="flex items-center space-x-2 text-sm cursor-pointer hover:bg-gray-50 p-2 rounded-md transition w-full sm:w-auto"
                      >
                        <input
                          type="radio"
                          value={status}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {types.map((type) => (
                      <label
                        key={type}
                        className="flex items-center space-x-2 text-sm cursor-pointer hover:bg-gray-50 p-2 rounded-md transition"
                      >
                        <input
                          type="radio"
                          value={type}
          ...
          <div
            className={`lg:col-span-8 ${
              activeTab !== "list" && "hidden sm:block"
            }`}
          >
              ...
              {isLoading ? (
                  ...
                  {filteredComics.map((comic) => (
                    ...
                    >
                      {comic.details.map((detail) => (
                        <Link
                          key={detail.id}
                          href={`/dashboard/${comic.id}/detailKomik/${detail.id}`}
                ...
                <div className="bg-gray-50 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Coba gunakan kata kunci pencarian yang berbeda atau
                    tambahkan komik baru.
                  </p>
                  <button
                    onClick={() => {
                      setSearchQuery("");
              ...
              <div className="space-y-4">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="relative w-full h-40 bg-gray-100 rounded-lg overflow-hidden">
                      <Image
                        ...
                        className="w-full h-full object-cover"
                        onError={() =>
                          setEditImageUrl("/placeholder-image.jpg")
                        }
                        width={320}
                        height={160}
                      />
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className={`px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 ${
                      isLoading
                        ? "bg-gray-400 cursor-not-allowed"
                        : "bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700"
                    }`}
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 text-center mb-6">
                Apakah Anda yakin ingin menghapus komik ini? Tindakan ini tidak
                dapat dibatalkan.
              </p>
