    ...
    const fetchComics = async () => {
      ...
      try {
        ...
        const allComics = querySnapshot.docs.map((doc) => ({
          ...
          publishDate:
            doc.data().publishDate || new Date().toISOString().split("T")[0],
        ...
        const paginated = sortedComics.slice(
          startIndex,
      ...
      <Layout>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <p className="mt-4 text-purple-400 text-lg font-medium">
              Memuat komik...
            </p>
          </div>
        </div>
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content={`Jelajahi koleksi komik kami - Halaman ${currentPage}`}
        />
      </Head>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div
            className={`w-full md:w-1/4 transition-all duration-300 ${
              isFilterOpen
                ? "fixed inset-0 z-40 bg-gray-900/95 backdrop-blur-sm p-4 overflow-y-auto"
                : "hidden md:block"
            }`}
          >
            <div className="sticky top-24">
              <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-white bg-gradient-to-br from-purple-500 to-pink-500 p-4 rounded-lg shadow-lg backdrop-blur-sm">
                  Filter Komik
                </h1>
                <button
          ...
          <div className="w-full bg-gray-900/50 md:w-3/4">
            <div className="flex flex-col gap-6">
                  ...
                  {isDropdownOpen && (
                    <div className="absolute z-50 top-full right-0 mt-1 w-full bg-gray-800/95 backdrop-blur-sm rounded-lg shadow-lg border border-gray-700/50 animate-fadeIn">
                      <div className="relative z-50">
                        <ul className="z-50">
                          <li
                            className="px-4 py-2 hover:bg-purple-500/20 cursor-pointer z-50 transition-colors duration-300"
              ...
              {filteredComics.length === 0 ? (
                <div className="bg-gray-900/95 z-0 backdrop-blur-sm p-8 rounded-lg text-center border border-gray-700/50 shadow-lg">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gray-700/50 rounded-full mb-4">
                    <X className="w-8 h-8 text-gray-400" />
                  </div>
                  <p className="text-xl text-gray-300">
                    Tidak ada komik dengan filter ini.
                  </p>
                </div>
              ) : (
                <div
                  ...
                  {filteredComics.map((comic) => (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <h2
                            className={`font-medium truncate group-hover:text-purple-400 transition-colors ${
                              viewMode === "grid" ? "text-sm" : "text-lg mb-1"
                            }`}
                          >
                            {comic.title}
                          </h2>
